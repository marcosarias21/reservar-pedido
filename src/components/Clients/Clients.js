  ...
  return (
      <div className="card col-3 mt-1">
        <div className="card-body">
          ...
          <hr/>
          <button type="button" onClick={() => setUserPedido(!userPedido)} className="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Historial de pedidos:</button>
          {
