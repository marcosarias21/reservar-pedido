  ...
  return (
    <div id="carouselExampleControls" className="carousel slide" data-bs-ride="false">
      <div className="carousel-inner">
        {dataFood.map(data => (
      <div key={data.nameFood} className={`carousel-item ${data.active}`}>
        <div className="card card-carousel row">
            <div className="row card-body col-12 col-sm-12 col-md-6 col-lg-6 d-flex flex-column justify-content-center align-items-center">
